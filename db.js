...
function seedSampleData() {
  const samplePages = [
    { name: "Oriental-Inspired Home Decor", page_id: "105542329243433", bm: "AVE Global 5.1", workflow: "n8n decor 1", status: "Active", staff: "Đức decor n8n", topic: "KOC review gia dụng" },
    { name: "Entryway Emporium", page_id: "321776644349815", bm: "AVE Global 5.1", workflow: "n8n decor 2", status: "Active", staff: "Đức decor n8n", topic: "KOC review gia dụng" },
    { name: "TechExpertise Hub", page_id: "201515329711126", bm: "AVE Global 5.1", workflow: "n8n decor 3", status: "Active", staff: "Đức decor n8n", topic: "KOC review gia dụng" },
    { name: "Home Innovations", page_id: "351944711341364", bm: "AVE Global 5.1", workflow: "n8n decor 4", status: "Active", staff: "Đức decor n8n", topic: "KOC review gia dụng" },
    { name: "Rustic Kitchen Spot", page_id: "213806318473811", bm: "AVE Global 5.1", workflow: "n8n decor 5", status: "Active", staff: "Đức decor n8n", topic: "KOC review gia dụng" },
    { name: "Home Essentials Emporium", page_id: "284558068082200", bm: "AVE Global 5.1", workflow: "n8n decor 11", status: "Active", staff: "Đức decor n8n", topic: "KOC review decor" },
    { name: "Home Feast Decor", page_id: "313945568464760", bm: "AVE Global 5.1", workflow: "n8n decor 12", status: "Active", staff: "Đức decor n8n", topic: "KOC review decor" },
    { name: "Kingdom Kraze", page_id: "339850282535287", bm: "AVE Global 5.1", workflow: "n8n decor 13", status: "Active", staff: "Đức decor n8n", topic: "KOC review decor" },
    { name: "Desert-Inspired Home Design", page_id: "100311526445290", bm: "AVE Global 1.5", workflow: "n8n decor 14", status: "Active", staff: "Đức decor n8n", topic: "KOC review decor" },
    { name: "Intérieur Chic", page_id: "266409643219582", bm: "AVE Tool 2.7", workflow: "n8n decor 21", status: "Active", staff: "Đức decor n8n", topic: "Top trend review" },
    { name: "Ambiance Apaisante", page_id: "241482175722896", bm: "AVE Tool 2.7", workflow: "n8n decor 22", status: "Active", staff: "Đức decor n8n", topic: "Top trend review" },
    { name: "Atmosphère Harmonieuse", page_id: "285486621304856", bm: "AVE Tool 2.7", workflow: "n8n decor 23", status: "Active", staff: "Đức decor n8n", topic: "Top trend review" },
    { name: "Urban Oasis", page_id: "116012434869808", bm: "AVE Global 1.5", workflow: "n8n fitness 1", status: "Active", staff: "Đức n8n Fitness", topic: "Fitness & Sức khỏe" },
    { name: "DIY Decor Hacks", page_id: "105748409222743", bm: "AVE Global 5.1", workflow: "n8n decor 8", status: "Active", staff: "Nguyễn Văn A", topic: "KOC review decor" },
    { name: "Retro Modern Furniture", page_id: "106175722516003", bm: "AVE Tool 1.2", workflow: "n8n decor 17", status: "Active", staff: "Trần Thị B", topic: "KOC review gia dụng" }
  ];
